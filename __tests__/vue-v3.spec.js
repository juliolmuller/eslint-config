...
const configFile = require('../vue/v3')

describe('Check overall configuration', () => {
  it('It is extending all plugin\'s configurations', () => {
    expect(configFile.extends).toContain('plugin:vue/vue3-essential')
  })
...
describe('Check Vue rules', () => {
  ...
  it('There are 10 rules configured', () => {
    expect(configRulesName.length).toBe(10)
  })
